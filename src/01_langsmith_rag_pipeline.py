...
def ask(chain, question: str) -> str:
    ...
    Có cơ chế retry tự động khi gặp RateLimitError (429).
    """
    max_retries = 5
    for attempt in range(max_retries):
        try:
            ...
            if "429" in str(e) or "rate" in str(e).lower():
                ...
                print(f"⚠️  Gặp RateLimit, đang thử lại sau {wait_time}s (lần thử {attempt + 1}/{max_retries})...")
...
def main():
    ...
    for i, question in enumerate(SAMPLE_QUESTIONS, 1):
        ...
        time.sleep(1)  # Giảm tải cho API tránh dính Rate Limit liên tục
