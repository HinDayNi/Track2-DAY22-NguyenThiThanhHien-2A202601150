...
PROMPT_V1_NAME = "nguyen-thi-thanh-hien-rag-v1"
PROMPT_V2_NAME = "nguyen-thi-thanh-hien-rag-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1: concise, factual RAG answers",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2: structured expert RAG answers",
        )
